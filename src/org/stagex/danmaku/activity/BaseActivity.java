...
public class BaseActivity extends AbsListViewBaseActivity implements
	...
	public int[] KKTV_HOME_MENU_Normal = {0, R.drawable.tab_recommend_normal, R.drawable.tab_channel_normal, R.drawable.btn_favorite_icon, R.drawable.default_img, R.drawable.radio, R.drawable.senven_normal, R.drawable.tab_more_normal};
	public int[] KKTV_HOME_MENU_Select = {0, R.drawable.tab_recommend_select, R.drawable.tab_channel_select, R.drawable.btn_favorite_icon_select, R.drawable.default_img_select, R.drawable.radio_select, R.drawable.senven_select, R.drawable.tab_more_normal_select};
	@Override
